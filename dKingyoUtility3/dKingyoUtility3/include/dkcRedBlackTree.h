...
typedef enum { edkcBLACK=0, edkcRED } edkRedBlackColor;      
...
#if 0
#define DEFINE_RED_BLACK_NODE(node_name,data_type) \
typedef struct node_name##__ {
   struct node_name##__ *left;         /* left child */ \
   struct node_name##__ *right;        /* right child */\
   struct node_name##__ *parent;       /* parent */\
