...
boost::crcのC言語版を目指していると考えていただくと分かりやすいかと･･･。<br>
それにしてもboost::crcの実装はかなりE感じ。<br>
ULONGとしている所がE感じのテクだと思った。<br>
（MinGW等ではtemplate<class T,class C=std::vector<T> >みたいな事が出来ない。)<br>
