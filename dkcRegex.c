...
@param
@note
target_data_size < replace_data_size�̎��̓G���[
*/
/*
...
{
//	/*edkcRegType*/int           type; // ���̃m�[�h�̎��
	int						type;
	wchar_t       ch; // ����
	RegClass*     cls; // �����W��
	BOOL          cmpcls; // ����W�����ǂ���
	struct RegNode_*			left; // ���̎q
	struct RegNode_*			right; // �E�̎q
}RegNode;
